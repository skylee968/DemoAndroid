...
import com.onetech.mobilereader.entity.ServerEntity;
...
import com.onetech.mobilereader.fragments.RegisterFragment;
 ...
 */
public class RegisterActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks,
...
//        window.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    private void initView(Bundle savedInstanceState) {
        mRegisterFragment       = (RegisterFragment) getSupportFragmentManager().findFragmentById(R.id.register_fragment);
...
//        mBtnLogin.setOnClickListener(this);
        ...
        mRegisterFragment.setRegisterHandler(new RegisterFragment.RegisterHandler() {
            @Override
            ...
            @Override
            public void onSuccessRegister(RegisterResultEntity result) {
                go2LoginPage();
            }
        });
    }
