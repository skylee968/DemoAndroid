 ...
 * It contains methods which provide you the available space in different units
 * e.g bytes, KB, MB, GB. OR you can get the number of available blocks on
 * external storage.
 * 
 */
public class AvailableSpaceUtil {
